...
// Buscar Pokémon
export const searchPokemon = (query, allPokemon, setAllPokemon) => {
...
export const getImageByMode = (pokemon) => {
    const displayMode = document.getElementById('display-mode')?.value || 'modern';
